            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container py-5">
                           ...
                           include 'connect.php';
                            $query = "select * from productdb WHERE type='novels'";
                                ...
                                while($row=mysqli_fetch_assoc($query_run)){
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="card"  style=" height: 49rem;" >
                                         ...
                                         <?php echo '<center><img src="data:image/jpg;base64,'.base64_encode( $row['product_image'] ).'"alt="book images" style="width:300px; height:350px;">';?>
